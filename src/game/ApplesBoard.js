    ...
    <div className="Game">
      <div className="View">
        ...
        {ctx.currentPlayer === playerID ?
          <JudgeView G={G} ctx={ctx} moves={moves} roundTime={roundTime} setRoundTime={setRoundTime} /> :
          <PlayerView G={G} ctx={ctx} moves={moves} playerID={playerID} roundTime={roundTime} setRoundTime={setRoundTime} />
        }
      </div>
      {winner}
    </div>
