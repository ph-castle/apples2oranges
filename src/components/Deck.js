export const Deck = [
  ...
  {id: 13, text: 'A tricked out 1964 Impala Low Rider', type: 'Answer'},
  {id: 14, text: 'Shouting the N-Word like a French police siren', type: 'Answer'},
  {id: 15, text: 'Doing all of the drugs', type: 'Answer'},
  {id: 16, text: 'Drinking polluted sea water', type: 'Answer'},
  {id: 17, text: 'Shredding the gnar!', type: 'Answer'},
  {id: 18, text: 'GET TO THE CHOPPA!!!', type: 'Answer'},
  {id: 19, text: 'Open the door, get on the floor, everybody walk the dinosaur!', type: 'Answer'},
  {id: 20, text: 'Taking an aqua-dump', type: 'Answer'},
  {id: 21, text: 'Putting hand-sanitizer in the microwave', type: 'Answer'},
]