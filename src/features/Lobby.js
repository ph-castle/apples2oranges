    ...
    <StyledComponentContainer>
      <Box>
        ...
        <StyledInnerBox>
          ...
          />
          <Button variant="contained" onClick={() => joinMatchHandler(sessionCode)}>
            Join
          </Button>
        </StyledInnerBox>
      </Box>
      <Box sx={{ width: "100%", height: '100%'}}>
        ...
        >
          {playerMatch.map((match) => (
            ...
            <Button sx={ {left: {sm: '60%', md: '70%'}, top: '-20%', color: 'white'}} onClick={(e) => joinMatchHandler(match.matchID)}>Join Game</Button>
            </div>
          ))}
        </Box>
      </Box>
